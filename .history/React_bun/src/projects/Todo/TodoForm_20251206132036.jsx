...
export const TodoForm = ({onAddTodo}) => {
    ...
    const handleFormSubmit = ( event) => {
        ...
        onAddTodo(inputData);
        //setInputData(""); // Clear the input field after submission but now as a string(element)
        setInputData({ id: "", content: "", checked: false}); // Clear the input field after submission but now as object
